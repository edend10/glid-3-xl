...
# and https://github.com/meadowdata/meadowrun-dallemini-demo/blob/main/linux/glid3xl_wrapper.py
...
results = do_run(init_image=Image.open("testimg.jpeg"), text="a cyberpunk girl with a scifi neuralink device on her head", num_batches=1, batch_size=2, steps=100, skip_rate=0.6)
print("Done. Saving images...")
for i, batch in enumerate(results):
    for j, img in enumerate(batch):
        img.save(f"output/{i}_{j}.png")
